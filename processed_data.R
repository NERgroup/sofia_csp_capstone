...
load("lda_patch_transitionsv2.rda")
...
#site_id_final has correct patch types 

#saved dataframe to project directory
saveRDS(urchin_sizefq_joined, file = "urchin_sizefq_joined.rds")
